...
from datasets.soccernet_dataset import CustomDataset
...
# Dataset
parser.add_argument('--dataset', default='soccernet', choices=['lvu', 'Breakfast', 'COIN'], type=str, help='Dataset')
...
parser.add_argument('--l_secs', default=9, type=int, help='l_secs')
# Model
...
parser.add_argument('--num_long_term_classes', default=8, type=int, help='num_long_term_classes')
